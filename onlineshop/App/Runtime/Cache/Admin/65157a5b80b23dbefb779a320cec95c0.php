...
<table height="100%" cellspacing=0 cellpadding=0 width=170 background=<?php echo (C("ADMIN_IMG_URL")); ?>/menu_bg.jpg border=0>
    ...
    <div class="crumbs">
        当前位置：商品管理-><a href="/index.php/Admin/Category/append">添加分类</a>
        <a href="/index.php/Admin/Category/showlist">【分类列表】</a>
    </div>

    <div class="tab-div">
        <form action="/index.php/Admin/Category/append" method="post">
            <table width="90%" cellpadding="1" cellspacing="0" style="margin-top: 10px">
                <tr>
                    ...
                    <td>
                        <select name="cat_pid">
                            ...
                            <?php if(is_array($pinfo)): foreach($pinfo as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>">
                                    <?php echo str_repeat('&nbsp;&nbsp;',$v['cat_level']); echo ($v["cat_name"]); ?>
