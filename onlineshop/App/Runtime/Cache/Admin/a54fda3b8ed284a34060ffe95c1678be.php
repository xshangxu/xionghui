...
<table height="100%" cellspacing=0 cellpadding=0 width=170 background=<?php echo (C("ADMIN_IMG_URL")); ?>/menu_bg.jpg border=0>
    ...
    <div class="crumbs">
        当前位置：商品管理-><a href="/index.php/Admin/Category/showlist">分类列表</a>
        <a href="/index.php/Admin/Category/append">【添加分类】</a>
    </div>
    ...
    <table width="100%" cellpadding="1" cellspacing="0" class="tablelist" style="margin-top: 10px">
        ...
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr align="center">
                ...
                <td align="left"><?php echo str_repeat('&nbsp;&nbsp;&nbsp;',$v['cat_level']); echo ($v["cat_name"]); ?></td>
                <td><?php echo ($v["cat_pid"]); ?></td>
                <td><?php echo ($v["cat_path"]); ?></td>
                <td><?php echo ($v["cat_level"]); ?></td>
                <td><a href="/index.php/Admin/Category/upd/cat_id/<?php echo ($v["cat_id"]); ?>">修改</a></td>
                <td><a href="javascript:;"onclick="if(confirm('确定要删除吗？')){
                     window.location.href = '/index.php/Admin/Category/del/cat_id/<?php echo ($v["cat_id"]); ?>';}">删除</a>
                </td>
