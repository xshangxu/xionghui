...
<table height="100%" cellspacing=0 cellpadding=0 width=170 background=<?php echo (C("ADMIN_IMG_URL")); ?>/menu_bg.jpg border=0>
    ...
    <div class="crumbs">
        当前位置：商品管理-><a href="/index.php/Admin/Type/append">添加商品类型</a>
        <a href="/index.php/Admin/Type/showlist">【商品类型列表】</a>
    </div>

    <div class="tab-div">
        <form action="/index.php/Admin/Type/append" method="post">
            <table width="100%" cellpadding="1" cellspacing="0" style="margin-top: 10px">
                <tr>
                    <td align="right" class="label">类型名称：</td>
