...
<table height="100%" cellspacing=0 cellpadding=0 width=170 background=<?php echo (C("ADMIN_IMG_URL")); ?>/menu_bg.jpg border=0>
    ...
    <div class="crumbs">
        当前位置：商品管理->
        <a href="/index.php/Admin/Brand/upd">修改商品品牌</a>
        <a href="/index.php/Admin/Brand/showlist">【商品品牌列表】</a>
    </div>

    <div class="tab-div tabbody-div">
        <form action="/index.php/Admin/Brand/upd/brand_id/1" method="post">
            <table width="100%">
                <tr>
                    <td align="right" class="label">品牌名称：</td>
                    <td><input type="text" name="brand_name" value="<?php echo ($info["brand_name"]); ?>"></td>
                </tr>
                <tr>
                    <td align="right" class="label">品牌网络地址：</td>
                    <td><input type="url" name="brand_url" value="<?php echo ($info["brand_url"]); ?>"></td>
                </tr>
