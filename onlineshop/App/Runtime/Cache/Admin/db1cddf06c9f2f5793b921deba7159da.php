...
<table height="100%" cellspacing=0 cellpadding=0 width=170 background=<?php echo (C("ADMIN_IMG_URL")); ?>/menu_bg.jpg border=0>
    ...
    <div class="tab-div tabbody-div">
        <form action="/index.php/Admin/Attribute/append.html" method="post">
            <table width="100%">
                <tr>
                ...
                <tr>
                    ...
                    <td class="attrfont">
                        ...
                        <input type="radio" name="attr_input_type" value="1">重下面列表中选择（一行代表一个可选值）
                    </td>
                </tr>
                <tr>
                    <td align="right" class="label">可选值列表：</td>
                    <td><textarea name="attr_opt"  cols="30" rows="5"></textarea></td>
                </tr>
            </table>
